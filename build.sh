...
mvn clean install
cp target/batMob-0.0.6-full.jar /mnt/c/Users/larsr/batclient/plugins/
cp batMobCli.bcs /mnt/c/Users/larsr/batclient/scripts/
#/Users/axu/bat/Batclient.app/Contents/MacOS/batclient
#javaws ~/Downloads/batclient.jnlp

#cp target/batMob-0.0.5-full.jar ~/batclient/plugins/
