...
public class SearchPanel extends JPanel implements
    ...
    private TreeSet<String> areas = new TreeSet<String>();
    ...
    public SearchPanel(SearchEngine searchEngine) {
        ...
        // areaSelect.setMaximumSize( new Dimension( LAYOUT_WIDTH - 60,
        // TEXT_INPUT_HEIGHT) );
        // areaSelect.setMinimumSize( new Dimension( LAYOUT_WIDTH - 60,
        // TEXT_INPUT_HEIGHT) );
        ...
        areaSelect.addKeyListener(this);
    ...
    private void populateSelect() {
        ...
        while (iter.hasNext()) {
            ...
            if (e.getValue().getArea() != null) {
                this.areas.add(e.getValue().getArea());
            }
        }
    ...
    public void keyPressed(java.awt.event.KeyEvent e) {
        if (e.getSource() == this.areaSelect) {
            String area = (String) this.areaSelect.getEditor().getItem();            
            if (area != null && !area.isEmpty()) {
                Iterator<String> it = this.areas.iterator();
                while (it.hasNext()) {
                    String item = it.next();
                    if (item.startsWith(area)) {
                        this.areaSelect.getModel().setSelectedItem(item);
                        break;
                    }
                }
            }
